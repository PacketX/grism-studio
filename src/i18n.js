...
export const STUDIO_VERSION = "2.86.0";
...
export const I18N = {
  en: {
    ...
    "set.mec": "MEC (S1AP / GTP)",
    "set.mecNote": "Correlates S1AP signalling with the GTP user traffic that belongs to it, so a subscriber's session can be followed across both.",
    "set.mecS1c": "Correlate S1AP (S1-C) signalling",
    "set.mecGtpDecap": "Decapsulate inbound GTP (same switch as In-tunnel inspection)",
    "set.mecFlowExt": "Carry the GTP tunnel header in the flow extension",
    "set.mecSweep": "Clearing idle entries",
    "set.mecSweepNote": "A sweep drops S1AP table entries nothing has touched for a while, so the table does not fill up with sessions that ended.",
    ...
    "set.mecSweepOff": "The sweep only runs while S1AP correlation is on.",
    "set.mecNeedsGtp": "Correlating without decapsulating GTP correlates nothing.",
  ...
  "zh-TW": {
    ...
    "set.mec": "MEC (S1AP / GTP)",
    "set.mecNote": "把 S1AP 信令與對應的 GTP 使用者流量關聯起來,讓同一個用戶的連線可以跨兩者追蹤。",
    "set.mecS1c": "關聯 S1AP (S1-C) 信令",
    "set.mecGtpDecap": "解封裝進入的 GTP(與入口通道檢查同一個開關)",
    "set.mecFlowExt": "在流量延伸資訊中帶入 GTP 通道標頭",
    "set.mecSweep": "清除閒置項目",
    "set.mecSweepNote": "定期清掉一段時間沒有動靜的 S1AP 項目,避免表格被已結束的連線塞滿。",
    ...
    "set.mecSweepOff": "只有在 S1AP 關聯開啟時才會執行清除。",
    "set.mecNeedsGtp": "沒有解封裝 GTP 的話,關聯不到任何東西。",
