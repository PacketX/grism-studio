...
export const STUDIO_VERSION = "2.176.0";
...
export const I18N = {
  en: {
    ...
    "cap.rwTitle": "Capturing on these interfaces carries a risk",
    ...
    "set.svcWebWarn": "pyhttpd is this web interface. Switching it off stops nginx and the API a couple of seconds from now: this page stops working, and the only way back is a shell on the device.",
    ...
    "set.upSshdNote": "an OpenSSH build for this machine.",
  ...
  "zh-TW": {
    ...
    "set.svcWebWarn": "pyhttpd 就是這個網頁介面。關掉它會在兩秒後停掉 nginx 與 API:這個頁面會失去回應,只能從裝置的命令列救回來。",
    ...
    "set.upSshdNote": "對應這台機器架構的 OpenSSH 封存檔。",
