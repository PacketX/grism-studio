...
export const STUDIO_VERSION = "2.52.0";
...
export const I18N = {
  en: {
    ...
    "set.fwCheckingNote": "Asking the update server for the latest release…", "set.fwFound": "Update available:", "set.fwUpToDate": "No newer release was offered.",
  ...
  "zh-TW": {
    ...
    "set.fwCheckingNote": "正在向更新伺服器查詢最新版本…", "set.fwFound": "有可用更新:", "set.fwUpToDate": "目前沒有更新版本。",
