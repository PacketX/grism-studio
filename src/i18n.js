...
export const I18N = {
  en: {
    ...
    "tf.desc": "Description", "tf.flowV4": "IPv4 flow", "tf.flowV6": "IPv6 flow",
    ...
    "nav.showAdvancedTip": "Show inputs, outputs and actions",
    "nav.hideAdvancedTip": "Hide the empty advanced sections",
    ...
    "ov.currentTitle": "Current configuration",
  ...
  "zh-TW": {
    ...
    "tf.desc": "描述", "tf.flowV4": "IPv4 flow", "tf.flowV6": "IPv6 flow",
    ...
    "nav.advanced": "進階",
    "nav.showAdvancedTip": "顯示 inputs、outputs 與 actions",
    "nav.hideAdvancedTip": "收合空的進階項目",
