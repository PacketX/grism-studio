...
export const STUDIO_VERSION = "2.99.0";
...
export const I18N = {
  en: {
    ...
    "set.switchPort": "Port",
    "set.switchGbic": "Transceiver",
    "set.switchPower": "RX power",
    "set.switch100g": "{port} at 100G takes {ports} with it — the switch shuts those down.",
    "set.switch100gNote": "Four ports can run at 100G, each using the lanes of the three beside it.",
  ...
  "zh-TW": {
    ...
    "set.switchPort": "埠",
    "set.switchGbic": "光模組",
    "set.switchPower": "RX 功率",
    "set.switch100g": "{port} 設為 100G 會佔用 {ports} — 交換器會把它們關閉。",
    "set.switch100gNote": "有四個埠可以跑 100G,每個都會用掉旁邊三個埠的通道。",
