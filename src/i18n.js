...
export const STUDIO_VERSION = "2.112.0";
...
export const I18N = {
  en: {
    ...
    "set.svcAlwaysOn": "always on",
    "set.svcAlwaysOnTip": "The packet application is what the device does. There is no useful state with it switched off, so it has no switch.",
    "set.upTitle": "Update a component",
    ...
    "set.upStudioNote": "grism-studio.tgz — the built web interface, as build.sh packs it into an image.",
    "set.upPywww": "Web server (pyhttpd / pywww)",
    "set.upPywwwNote": "A tarball of scripts/pywww. nginx is reloaded afterwards; pywww reloads itself.",
    "set.upGo": "Upload and update", "set.upSending": "uploading…",
    "set.upFailed": "Update failed",
    "set.upDone": "Updated.",
    "set.upDoneStudio": "Updated. This page is the build that was just replaced — reload to run the new one.",
    "set.upReload": "Reload",
    "set.uploadTitle": "Replace this component?",
    ...
    "set.switchMode.normal": "normal (per port)",
    "set.switchMode.custom": "custom (text)",
    "set.switchRestartNote": "Applying restarts the switch, which takes about {n} seconds and drops every link while it happens.",
    "set.switchPorts": "Ports",
    "set.switchPort": "Port",
    "set.switchGbicPn": "GBIC part no.",
    "set.switchGbicSn": "GBIC serial",
    "set.switchRx": "GBIC RX power",
    "set.switchTx": "GBIC TX power",
    ...
    "set.cpssRestartTitle": "Restart the switch service?",
    "set.cpssRestartBody": "Every link drops while it comes back.",
    "set.cpssDownNote": "The switch is not running: the ports below report whatever it last said, and nothing will pass until it is back.",
    "set.switchCustom": "Custom configuration",
    "set.switchCustomNote": "The file the switch reads, as it stands. It is applied as written.",
    "set.switchModeTitle": "Change the switch configuration?",
    "set.switchModeBody": "The switch will read the other file from now on.",
    "set.switchRowsTitle": "Apply the port settings?",
    "set.switchRowsBody": "The changed ports are written to the switch configuration.",
    "set.switchCustomTitle": "Apply the custom configuration?",
    "set.switchCustomBody": "The text is written to the switch configuration exactly as it stands.",
    "set.switchRestarting": "Restarting the switch",
    "set.switchRestartingBody": "Links are down while it comes back. This page unlocks when it is done.",
    "set.switchSeconds": "{n} seconds left",
    ...
    "panel.mgmtM0": "MGMT (M0)",
    "panel.mgmtHub": "MGMT — eight sockets on a switch hub, uplinked to M0",
  ...
  "zh-TW": {
    ...
    "set.svcAlwaysOn": "必要服務",
    "set.svcAlwaysOnTip": "封包處理程式就是這台裝置的用途,關掉它沒有任何意義,因此不提供開關。",
    "set.upTitle": "手動更新元件",
    "set.upNote": "上傳單一元件的更新檔,不必重新燒錄整個韌體。檔案會先檢查過才會取代現有內容。",
    "set.upTarget": "元件", "set.upFile": "檔案",
    "set.upStudio": "網頁介面 (grism-studio)",
    "set.upStudioNote": "grism-studio.tgz — 建置好的網頁介面,與 build.sh 打包進韌體的是同一份。",
    "set.upPywww": "網頁伺服器 (pyhttpd / pywww)",
    "set.upPywwwNote": "scripts/pywww 的壓縮檔。更新後會重新載入 nginx,pywww 會自行重新載入。",
    "set.upGo": "上傳並更新", "set.upSending": "上傳中…",
    "set.upFailed": "更新失敗",
    "set.upDone": "已更新。",
    "set.upDoneStudio": "已更新。目前這個頁面就是剛被取代的版本 — 請重新載入以執行新版。",
    "set.upReload": "重新載入",
    "set.uploadTitle": "要取代這個元件嗎?",
    ...
    "set.switchMode": "設定方式",
    "set.switchMode.normal": "一般(逐埠設定)",
    "set.switchMode.custom": "自訂(文字)",
    "set.switchRestartNote": "套用後交換器會重新啟動,大約需要 {n} 秒,期間所有連線都會中斷。",
    "set.switchPorts": "連接埠",
    "set.switchPort": "埠",
    "set.switchGbicPn": "GBIC 料號",
    "set.switchGbicSn": "GBIC 序號",
    "set.switchRx": "GBIC RX 功率",
    "set.switchTx": "GBIC TX 功率",
    ...
    "set.cpssRestartTitle": "要重新啟動交換器服務嗎?",
    "set.cpssRestartBody": "重新啟動期間所有連線都會中斷。",
    "set.cpssDownNote": "交換器目前沒有執行:下方顯示的是它最後回報的狀態,在它恢復之前不會有流量通過。",
    "set.switchCustom": "自訂設定",
    "set.switchCustomNote": "交換器目前讀取的設定內容,會原樣套用。",
    "set.switchModeTitle": "要更換交換器的設定方式嗎?",
    "set.switchModeBody": "交換器之後會改讀另一個設定檔。",
    "set.switchRowsTitle": "要套用連接埠設定嗎?",
    "set.switchRowsBody": "變更的埠會寫入交換器設定。",
    "set.switchCustomTitle": "要套用自訂設定嗎?",
    "set.switchCustomBody": "這段文字會原樣寫入交換器設定。",
    "set.switchRestarting": "交換器重新啟動中",
    "set.switchRestartingBody": "重新啟動期間連線會中斷,完成後畫面就會解除鎖定。",
    "set.switchSeconds": "還剩 {n} 秒",
    "set.portMac": "MAC 位址",
    ...
    "panel.mgmtUsb": "MGMT (USB)",
    "panel.mgmtM0": "MGMT (M0)",
    "panel.mgmtHub": "MGMT — 八個插孔是一組 switch hub,內部接到 M0",
